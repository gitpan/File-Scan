#
# Scan.pm
# Last Modification: Fri Mar 26 15:24:03 WET 2004
#
...
__DATA__
# generated in: 2004/03/26 15:27:48
...
sub get_app_sign {
	...
	/^\x4d\x5a/o and $_[0] = 4;
	/^\x4d\x5a\x00\x00\x01/o and return($_[1] = 1);
	/^\x4d\x5a\x00\x00\x02/o and return($_[1] = 2);
	/^\x4d\x5a\x42\x00\x02/o and return($_[1] = 3);
	/^\x4d\x5a\x50\x00\x02/o and return($_[1] = 4);
	/^\x4d\x5a\x90\x00\x03/o and return($_[1] = 5);
	/^\x4d\x5a\x93\x00\x01/o and return($_[1] = 6);
	...
	LINE: while(read(FILE, $buff, $size)) {
		...
		if($type == 1) {
			...
			if($subtype == 1) {
				...
				if($total==11264) {
					/\xe0\x5f\x4d\x69\x72\x63\x44\x43\x17\xa2/s and $virus = "W32_Darby\@MM", last LINE;
				...
				if($total==16384) {
					/\x7e\x3f\x41\x54\x41\x37\x43\x50\x54\x20\x54\x4f\x1e\x3c\xfd\x25\xc2\x6d\x0b\x3e\x10\x55\x4c\x20\x46\x52\x4f\x4d\x2b\xf8\x07\xee\x11\x00\xc7\x48\x45\x4c\x4f\xd3\xce\x3d\x3e\xc3\x4c\x13\x5c\xb3\xed\xc9\xfc\x7f\x7f\x63\x07\x65\x13\x2a\x2e\x2a\x1b/s and $virus = "W32/Netsky\@MM", last LINE;
				}
				if($total==17408) {
				...
				if($total==1024) {
					...
					//s and $virus = "W32/Netsky.p\@MM", last LINE;
				...
				if($total==8192) {
					//s and $virus = "W32/Bagle.u\@MM", last LINE;
