#
# Scan.pm
# Last Modification: Wed Apr 14 19:35:33 WEST 2004
#
...
__DATA__
# generated in: 2004/04/14 19:53:54
		...
		if($type == 1) {
			...
			if($subtype == 1) {
				...
				if($total==1024) {
					...
					/\xbb\xd0\x01\x40\x00\xbf\x00\x10\x40\x00\xbe((\x2c\x1c\x41)|(\x60\xda\x40))\x00\x53\xe8\x0a\x00\x00\x00\x02\xd2\x75\x05\x8a\x16\x46\x12\xd2\xc3\xfc\xb2\x80\xa4\x6a\x02\x5b\xff\x14\x24\x73\xf7\x33\xc9\xff\x14\x24\x73\x18\x33\xc0\xff\x14\x24\x73\x21\xb3\x02\x41\xb0\x10\xff\x14/s and $virus = "W32/Netsky.p\@MM", last LINE;
