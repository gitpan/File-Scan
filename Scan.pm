#
# Scan.pm
# Last Modification: Tue Sep 30 10:50:02 WEST 2003
#
...
__DATA__
# generated in: 2003/09/30 11:27:48
	...
	LINE: while(read(FILE, $buff, $size)) {
		...
		if($type == 1) {
			...
			if($subtype == 1) {
				...
				if($total==67584) {
					/\x48\x45\x4c\x4f\x20\x25\x73\x0d\x0a\x00\x00\x00\x32\x32\x30\x00\x5c\x67\x65\x72\x6d\x73\x31\x2e\x64\x62\x76\x00\x5c\x67\x65\x72\x6d\x73\x30\x2e\x64\x62\x76\x00\x43\x55\x53\x54\x4f\x4d\x00\x00\x2d\x2d/s and $virus = "W32/Swen\@MM", last LINE;
				}
				if($total<=4096) {
