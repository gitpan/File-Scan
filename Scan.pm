#
# Scan.pm
# Last Modification: Mon Mar  7 18:05:10 WET 2005
#
...
__DATA__
# generated in: 2005/03/07 18:20:34
	...
	LINE: while(read(FILE, $buff, $size)) {
		...
		if($type == 1) {
			...
			if(($total>=1024 && $total<=3072) || $total==25600) {
				/\xd0\x32\xc5\x32\xc2\x32\xc6\xd2\xc0\x02\xc1.{0,8}\xd3\xc2\x88\x07\x47\x49\x75\xd2\xe8\x01\x00\x00\x00/s and $virus = "W32/Bagle.ai\@MM", last LINE;
			}
			if($total>2048) {
