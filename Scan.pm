#
# Scan.pm
# Last Modification: Thu Feb 26 13:36:25 WET 2004
#
...
__DATA__
# generated in: 2004/02/26 13:52:19
...
sub get_app_sign {
	...
	/^\x4d\x5a\x93\x00\x01/o and return($_[1] = 5);
	...
	LINE: while(read(FILE, $buff, $size)) {
		...
		if($type == 1) {
			...
			if($subtype == 1) {
				...
				if($total==7168 || $total==14336) {
					/\x00\x48\x45\x4c\x4f.{5}\x00\x52\x53\x45\x54.{1,3}\x4d\x41\x49\x4c\x20\x46\x52\x4f\x4d\x3a.{7,8}\x43\x50\x54\x20\x54\x4f.{1,8}\x44\x41\x54\x41.{13}\x64\x64.{26,38}\x5c\x00\x2a\x2e\x2a/s and $virus = "W32/Bagle\@MM", last LINE;
				}
				...
				if($total==3072) {
					...
					//s and $virus = "W32/Netsky.c\@MM", last LINE;
				}
				if($total==31744) {
