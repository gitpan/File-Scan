#
# Scan.pm
# Last Modification: Sat Aug 19 22:52:19 WEST 2003
#
...
__DATA__
# generated in: 2003/08/19 23:08:50
	...
	LINE: while(read(FILE, $buff, $size)) {
		...
		if($type == 1) {
			...
			if($subtype == 1) {
				...
				if($total==71680) {
					/\x3c\xdf\x78\xd1\x0c\xf4\xca\x79\xc5\x03\xa8\xca\x1c\x8f\xb0\xdf\x57\x86\x8a\xba\xe7\x54\x70\xca\x27\xf2\x4e\x3b\xc7\x01\xbc\xc7\x75\xab\x8b\x23\x89\x14\x7d\x52\x05\x59\x3a\x62\x96\x10\xda\x5a\x62/s and $virus = "W32/Sobig.f\@MM", last LINE;
				}
				if($total==50176) {
