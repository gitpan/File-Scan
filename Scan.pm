#
# Scan.pm
# Last Modification: Sat Sep 18 18:48:56 WEST 2004
#
...
__DATA__
# generated in: 2004/09/18 19:07:58
		...
		if($type == 1) {
			...
			if($subtype == 1) {
				...
				if($total==1024) {
					...
					/\x55\x50\x58\x30\x00{5}[\x80\xd0\x70][\x00\x02]\x00\x00\x10\x00{7}[\x04\x02]\x00{14}\x80\x00\x00\xe0\x55\x50\x58\x31\x00{5}[\xc0\x60\x50]\x00\x00\x00[\xe0\x90\x80][\x02\x00]\x00\x00[\xbc\x60\x42]\x00\x00\x00[\x04\x02]\x00{14}\x40\x00\x00\xe0\x2e\x72\x73\x72\x63\x00{4}\x10\x00\x00\x00[\xa0\xf0\xd0][\x03\x00]\x00\x00[\x04\x08]\x00\x00\x00[\xc0\x64\x44]\x00{14}\x40\x00\x00\xc0[\x00\x0a]/s and $virus = "W32/Mydoom.o\@MM", last LINE;
				...
				if($total==2048 || $total==4096) {
					/\x52\x55\x4e\x44.{0,4}\x4c\x4c\x33\x32\x2e\x45\x58\x45\x20\x25\x73\x2c\x5f\x6d\x61\x69\x6e\x52\x44\x00\x44\x6c\x6c\x52\x65\x67\x69\x73\x74\x65\x72\x53.{2,5}\x76.{0,3}\x00\x00\x64\x6c\x6c\x00\x65\x78\x65\x00\x43\x4c\x53\x49\x44\x5c\x7b.{0,4}\x32\x37\x31\x36\x41\x36\x30\x45\x2d\x33\x42\x33\x39\x2d\x31\x31\x44\x38\x2d\x38\x31\x41\x42\x2d\x34.{0,2}\x35\x35.{0,4}\x33\x35\x34\x30.{0,2}\x31\x7d\x00.{1,3}\x20\x6d\x75\x74.{0,2}\x31\x20.{6}\x5c\x25\x63.{1,2}\x2e.{3,6}\x2a\x2e.{4,5}\x00\xbe.{1,2}\xb2\xa5\x6f\xff\xfc\xff.{22,60}\x45\xf1\xff\x4b\xf6\x32/s and $virus = "W32/Mabutu.a\@MM", last LINE;
				}
				if($total==50176) {
