#
# Scan.pm
# Last Modification: Tue Aug 17 14:29:30 WEST 2004
#
...
__DATA__
# generated in: 2004/08/17 14:42:45
		...
		if($type == 1) {
			...
			if($subtype == 1) {
				...
				if($total==1024) {
					...
					/\x55\x50\x58\x30\x00{5}[\x80\xd0][\x00\x02]\x00\x00\x10\x00{7}\x04\x00{14}\x80\x00\x00\xe0\x55\x50\x58\x31\x00{5}[\xc0\x60]\x00\x00\x00[\xe0\x90][\x02\x00]\x00\x00[\xbc\x60]\x00\x00\x00\x04\x00{14}\x40\x00\x00\xe0\x2e\x72\x73\x72\x63\x00{4}\x10\x00\x00\x00[\xa0\xf0][\x03\x00]\x00\x00[\x04\x08]\x00\x00\x00[\xc0\x64]\x00{14}\x40\x00\x00\xc0\x00/s and $virus = "W32/Mydoom.o\@MM", last LINE;
