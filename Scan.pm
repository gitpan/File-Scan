#
# Scan.pm
# Last Modification: Mon Jul 15 11:24:47 GMT 2002
#
...
__DATA__
# generated in: 2002/07/15 16:22:24

sub get_app_sign {
	$_ = pop;
	/^\xd0\xcf\x11\xe0\xa1\xb1\x1a\xe1/o and return($_[0] = 1);
	/^\x4d\x5a/o and $_[0] = 2;
	...
	/^\x49\x54\x53\x46/o and return($_[0] = 4);
	/^\x7f\x45\x4c\x46/o and return($_[0] = 5);
	/^\xe9/o and return($_[0] = 6);
	return(0);
}
	...
	LINE: while(read(FILE, $buff, $size)) {
		...
		if($type == 1) {
			...
			if($subtype == 1) {
				...
				if($total==20480) {
					/\x3a\x2d\x29\x00\x21\x07\x21\x04\x53\x43\x41\x4d\x33\x32\xfe\xbf\x3f\x77\x07\x49\x52\x43\x57\x49\x4e\x4b\x37\x5a\x4f\x4e\x45\x41\x4c\x41\x52\x4d/s and $virus = "W32/Yaha.gen\@MM", last LINE;
				}
				if($total<=4096) {
