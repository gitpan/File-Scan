#
# Scan.pm
# Last Modification: Sat Jun 12 15:24:14 WEST 2004
#
...
__DATA__
# generated in: 2004/06/12 15:47:14
...
sub scan_binary {
	...
	LINE: while(read(FILE, $buff, $size)) {
		...
		if($type == 1) {
			...
			if(($total>=1024 && $total<=5120) || $total==18432) {
				/[\xed\x8b].{0,13}\xe8.{0,50}\xe9.{0,12}\xff\xff\xff.{0,19}\x83/s and $virus = "W32/Netsky.c\@MM", last LINE;
			}
