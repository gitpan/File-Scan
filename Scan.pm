#
# Scan.pm
# Last Modification: Wed Jul 21 13:36:36 WEST 2004
#
...
__DATA__
# generated in: 2004/07/21 13:41:21
	...
	LINE: while(read(FILE, $buff, $size)) {
		...
		if($type == 1) {
			...
			if($subtype == 1) {
				...
				if($total==2048) {
					/\x23\x36\x55\x39\x36\x55\x39\x3a\x55\x39\x36\x55\x43\x36\x55\x39\x36\x55\x0f\x39\x36\x55\x39\x3a\x55\x39\x36\x55\x43\x36\x55\x39\x36\x55\x0f\x39\x2b\x7c\x24\x28\x89\x7c\x24/s and $virus = "W32/Bagle.ai\@MM", last LINE;
				}
				if($total<=3072) {
